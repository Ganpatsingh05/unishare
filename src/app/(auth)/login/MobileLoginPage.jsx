            ...
            {activeView === 'login' && (
              <div className="space-y-5">
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-center gap-3 h-14 rounded-2xl font-semibold transition-all duration-300 active:scale-[0.98] disabled:opacity-50 ${
                    darkMode
                      ? 'bg-[#24292e] border border-gray-700 text-white active:bg-[#2c3238]'
                      : 'bg-[#24292e] border border-[#24292e] text-white shadow-sm active:bg-[#2c3238]'
                  }`}
                >
                  {isLoading ? (
                    <Loader2 className="w-5 h-5 animate-spin" />
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className={`text-xs font-medium ${darkMode ? 'text-gray-500' : 'text-gray-400'}`}>or continue with email</span>
                  <div className={`flex-1 h-px ${darkMode ? 'bg-gray-800' : 'bg-gray-200'}`} />
                </div>
