...
export default function ItemDetailPage() {
  ...
  return (
    <div key={params.itemId} className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-900 dark:to-blue-900/20">
      

      <div className={`${isMobile ? 'px-4 pt-20 pb-8' : 'max-w-7xl mx-auto px-6 pt-24 pb-16'}`}>
